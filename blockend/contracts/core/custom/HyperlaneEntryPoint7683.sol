...
import {EntryPoint7683} from "./EntryPoint7683.sol";

/**
 * @title HyperlaneEntryPoint7683
 * @author BootNode
 * @notice This contract builds on top of Entrypoint as a messaging layer using Hyperlane.
 * @dev It integrates with the Hyperlane protocol for cross-chain communication.
 */
abstract contract HyperlaneEntryPoint7683 is GasRouter, EntryPoint7683 {
    // ============ Libraries ============
    ...
    constructor(
        address _mailbox,
        address _permit2
    ) GasRouter(_mailbox) EntryPoint7683(_permit2) {}
    ...
    function _dispatchSettle(
        ...
        _GasRouter_dispatch(
            _originDomain,
            msg.value,
            Hyperlane7683Message.encodeSettle(_orderIds, _ordersFillerData),
            address(hook)
        );
    }
    ...
    function _dispatchRefund(
        ...
        _GasRouter_dispatch(
            _originDomain,
            msg.value,
            Hyperlane7683Message.encodeRefund(_orderIds),
            address(hook)
        );
    }
