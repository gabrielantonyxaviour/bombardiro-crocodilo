...
import "./custom/EntryPoint7683.sol";
import "../interfaces/IEntryPointSimulations.sol";

/*
 * This contract inherits the EntryPoint7683 and extends it with the view-only methods that are executed by
 ...
 */
abstract contract EntryPointSimulations is
    EntryPoint7683,
    IEntryPointSimulations
{
     ...
     */
    constructor(address _permit2) EntryPoint7683(_permit2) {
